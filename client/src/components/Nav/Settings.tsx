...
export default function Settings({ open, onOpenChange }: TDialogProps) {
  ...
  const settingsTabs: {
    ...
    ...(hasAnyPersonalizationFeature
      ...
      : []),
    {
      value: SettingsTabValues.ENDPOINTS,
      icon: <GearIcon />,
      label: 'com_nav_setting_endpoints' as TranslationKeys,
    },
    {
              ...
              <div className="max-h-[550px] overflow-auto px-6 md:max-h-[400px] md:min-h-[400px] md:w-[680px]">
                ...
                >
                  ...
                  <div className="overflow-auto sm:w-full sm:max-w-none md:pr-0.5 md:pt-0.5">
                    ...
                    <Tabs.Content value={SettingsTabValues.ENDPOINTS} tabIndex={-1}>
                      <Endpoints />
                    </Tabs.Content>
